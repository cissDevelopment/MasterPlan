...
//        rank.leftAnchor.constraint(equalTo: view1.leftAnchor, constant:20).isActive = true
    ...
    private func setupLayoutView3(){
        ...
        signOut.topAnchor.constraint(equalTo: hideRanking.bottomAnchor, constant: spacing).isActive = true
        signOut.heightAnchor.constraint(equalToConstant: 40).isActive = true
        signOut.leftAnchor.constraint(equalTo: hideRanking.leftAnchor).isActive = true
        signOut.rightAnchor.constraint(equalTo: hideRankingSwitch.rightAnchor).isActive = true
    }
